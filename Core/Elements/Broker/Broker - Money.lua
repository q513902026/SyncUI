...
local function GetTotalTooltipInfo()
...
local function GetRealmPoolTooltipInfo(serverName, realmList)
	local total, numInfo = 0, 0;
	local waitForInfo = false;
	
	GameTooltip:AddLine("Realm Pool",1,1,1)
	GameTooltip:SetPrevLineJustify("CENTER")
	GameTooltip:AddDivider()
	...
	return total, numInfo, waitForInfo;
end

local function GetCurrentRealmTooltipInfo(serverName)
...
local function GetServerTooltipInfo(self)
		...
		if #realmList > 0 then	
			total, numInfo, waitForInfo = GetRealmPoolTooltipInfo(serverName, realmList);
		else
			total, numInfo, waitForInfo = GetCurrentRealmTooltipInfo(serverName);
		end
